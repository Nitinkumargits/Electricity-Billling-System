...
public class About extends JFrame implements ActionListener{
    ...
    public About(){
       ...
       s="                                About Project                    \n  "
               ...
               +"the department of elecricity  by computerizing the billing system."
               +"Its mainly focuses on the calculation of Units consumed during the"
               +"specified time and the money to be paid to elecricity offices"
